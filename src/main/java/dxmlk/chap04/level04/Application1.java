...
public class Application1 {
    public static void main(String[] args) {
        ...
        if (avg>=60 && korean>=40 && english>=40 && math>=40) {
            ...
            if(avg<60) {
                System.out.println("FAIL: AVERAGE UNDER 60");
            }
            if(korean<40) {
                System.out.println("FAIL: KOREAN UNDER 40");
            }
            if(english<40) {
                System.out.println("FAIL: ENGLISH UNDER 40");
            }
            if(math<40) {
                System.out.println("FAIL: MATH UNDER 40");
            }
        }
